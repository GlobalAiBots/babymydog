    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none text-[#1A1A1A] leading-relaxed space-y-6">
          ...
          <p>For safe, comfortable gear that makes daily exercise easier, explore our <Link href="/products/dog-harnesses" className="text-[#C4704B] hover:underline font-semibold">best dog harnesses</Link> and <Link href="/products/dog-gps-trackers" className="text-[#C4704B] hover:underline font-semibold">best GPS trackers</Link> guides.</p>
