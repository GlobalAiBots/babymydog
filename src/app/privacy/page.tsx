  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="space-y-4 text-gray-600 leading-relaxed text-sm">
        <p><BrandName /> (&quot;we&quot;, &quot;us&quot;) is committed to protecting your privacy. This policy explains how we collect and use information.</p>
        ...
        <p><BrandName /> participates in the Amazon Services LLC Associates Program. We earn commissions on qualifying purchases made through our affiliate links at no extra cost to you. See our <a href="/disclosure" className="text-rose hover:underline">Affiliate Disclosure</a> for details.</p>
