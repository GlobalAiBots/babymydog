  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="space-y-4 text-gray-600 leading-relaxed">
        <p><strong className="text-charcoal">BabyMyDog is a participant in the Amazon Services LLC Associates Program</strong> (Associate ID: babymydog03-20), an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com.</p>
