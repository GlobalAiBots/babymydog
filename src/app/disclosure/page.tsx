  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="space-y-4 text-gray-600 leading-relaxed">
        ...
        <p><strong className="text-charcoal">We also partner with select advertisers through CJ Affiliate</strong>, including Revival Animal Health. When you click on these links and make a purchase, we may earn a commission.</p>
