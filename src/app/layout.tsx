    ...
    <footer style={{background:'#2A2420'}} className="mt-24">
      <div className="max-w-[1200px] mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-sm">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-white/40">
              ...
              <a href="https://marinaseeker.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">MarinaSeeker</a>
              <a href="https://mechanicseeker.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">MechanicSeeker</a>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-white/25 text-xs">
          <p>Veteran Owned &amp; Operated &#127482;&#127480; &middot; Made with love for dog lovers everywhere &middot; &copy; {new Date().getFullYear()} <BrandName /></p>
