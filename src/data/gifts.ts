...
export const giftGuides: GiftGuide[] = [
  ...
  },
  {
    ...
    gifts: [
      ...
      { name: "West Paw Holiday Zogoflex Hurley Bone", price: "$15-25", description: "Tough, recyclable chew bone in seasonal red and green that is guaranteed against dog damage.", asin: "B00CPDWT2M" },
