...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    description:
      "A good collar should be comfortable for daily wear, visible in low light, and hold ID tags securely \u2014 here are collars that check every box.",
    picks: [
      {
        name: "Joytale Reflective Dog Collar",
        badge: "Best Overall",
        description:
          "Nylon collar with reflective stitching throughout and a quick-release buckle that makes it easy to take on and off.",
        features: [
          "Reflective threads woven into nylon",
      ...
      {
        name: "GoTags Personalized ID Tags",
        badge: "Best Value",
        description:
          "Stainless steel tags with deep laser engraving that won\u2019t fade or wear off, available in multiple shapes and colors.",
        features: [
          "Deep laser engraving lasts years",
          "Stainless steel resists rust",
          "Includes split ring for easy attachment",
        ],
        asin: "B085MH756K",
        rating: 4.6,
        reviewCount: "40K+",
      ...
      },
      {
        ...
        badge: "Best for Large Dogs",
        description:
          "Heavy-duty nylon collar with a metal buckle, control handle, and MOLLE-compatible design for working dogs.",
        features: [
          "Metal buckle rated for strong dogs",
          "Built-in handle for close control",
          "MOLLE webbing for attaching patches or gear",
        ],
        asin: "B0962R78HN",
        rating: 4.4,
        reviewCount: "8K+",
      ...
      {
        name: "TagME Small Dog Collar",
        badge: "Best for Small Dogs",
        description:
          "Lightweight adjustable collar sized specifically for small breeds with a personalized name plate built into the buckle.",
        features: [
          "Personalized stainless steel nameplate",
          "Soft padded neoprene lining",
          "Adjustable for 7 to 11 inch necks",
        ],
        asin: "B08PK7YRK7",
        rating: 4.4,
        reviewCount: "12K+",
      ...
      },
      {
        ...
        badge: "Best Budget",
        description:
          "Simple, durable nylon collar with reflective trim and a standard buckle at an unbeatable price point.",
        features: [
          "Reflective trim for night visibility",
          "Adjustable nylon webbing",
          "D-ring for leash and tag attachment",
        ],
        asin: "B08NSMMQFH",
        rating: 4.3,
        reviewCount: "15K+",
  ...
  },
  {
    ...
    description:
      "The right training tool makes learning easier for both you and your dog \u2014 from remote collars to head halters, these are the most effective options available.",
    picks: [
      {
        name: "Jugbow Dog Training Collar",
        badge: "Best Overall",
        description:
          "Rechargeable remote training collar with beep, vibration, and adjustable stimulation modes and a range of up to 1600 feet.",
        features: [
          "3 training modes: beep, vibration, stimulation",
          "1600-foot remote range",
          "Rechargeable and waterproof IPX7",
        ],
        asin: "B0FN7S5WMJ",
        rating: 4.4,
        reviewCount: "10K+",
      ...
      {
        name: "FAFAFROG Bark Collar",
        badge: "Best Value",
        description:
          "Automatic bark detection collar with progressive correction that starts with vibration before escalating, no remote needed.",
        features: [
          "Automatic bark detection with smart sensor",
          "5 adjustable sensitivity levels",
          "Rechargeable battery lasts 14 days",
        ],
        asin: "B09VT74GKL",
        rating: 4.3,
        reviewCount: "18K+",
      ...
      {
        name: "Bousnic Dog Training Collar",
        badge: "Editor\u2019s Choice",
        description:
          "Dual-dog training collar system that controls two dogs from one remote with independent channel settings.",
        features: [
          "Controls 2 dogs from 1 remote",
      ...
      },
      {
        ...
        badge: "Premium Pick",
        description:
          "Head halter that gently steers your dog by the nose, providing instant pulling control without choking or gagging.",
        features: [
          "Controls the head to control the body",
          "Padded nose loop for comfort",
          "Includes training DVD and quick-start guide",
        ],
        asin: "B00074L4RW",
        rating: 4.2,
        reviewCount: "30K+",
      ...
      },
      {
        ...
        badge: "Most Popular",
        description:
          "Basket-style muzzle that allows panting, drinking, and treat-taking while preventing biting \u2014 humane and vet-recommended.",
        features: [
          "Allows panting, drinking, and treat-taking",
          "Heat-moldable for custom fit",
          "Overhead safety strap prevents removal",
        ],
        asin: "B0051H45GC",
        rating: 4.3,
        reviewCount: "20K+",
